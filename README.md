...
Using a simplified version of the Unity Banana environment, the objective of the project is to train an agent to navigate (and collect bananas!) in a large, square world.
